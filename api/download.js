...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Gunakan API baru: https://api.sxtream.xyz/downloader/tiktokv2
    const apiUrl = `https://api.sxtream.xyz/downloader/tiktokv2?url=${encodeURIComponent(url)}`;
    ...
    if (response.data && response.data.status === 'success') {
      ...
      const formattedData = {
        success: true,
        result: {
          video: apiData.result.video || apiData.result.nowatermark,
          music: apiData.result.music,
          cover: apiData.result.cover,
          title: apiData.result.title || apiData.result.desc
        },
        title: apiData.result.title || apiData.result.desc,
        desc: apiData.result.desc,
        cover: apiData.result.cover,
        video: apiData.result.video || apiData.result.nowatermark,
        music: apiData.result.music,
        audio: apiData.result.music,
        nowatermark: apiData.result.video || apiData.result.nowatermark
      };
